  ...
  return (
    <div className='about'>
        ...
        <p>
            ...
            our programs prepare aspiring educators to make a meaningful impact in classrooms, schools, 
            and commmunities.
        </p>
        <p>
            Whether you aspire to become a teacher, administrator,
            counselor, or educational leader, our diverse range of programs
            offers the perfecct pathway to achieve your goals and unlock your full potential in shaping 
